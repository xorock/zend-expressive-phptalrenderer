 ...
 * </code>
 *
 * Note: the various keys in the `phptal` configuration key can occur in either
 * that location, or under `templates`;
...
class PhptalRendererFactory
{
     ...
     */
    private function injectHelpers(PHPTAL $template, ContainerInterface $container)
    {        
